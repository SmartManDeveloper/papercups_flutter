      ...
      getCustomerHistory(
        ...
        if (failed) {
          Alert.show(
            ...
            context,
            textStyle: widget.props.style.chatNoConnectionAlertTextStyle ?? Theme.of(context).textTheme.bodyMedium,
            backgroundColor:
                widget.props.style.chatNoConnectionAlertBackgroundColor ?? Theme.of(context).bottomAppBarTheme.color!,
